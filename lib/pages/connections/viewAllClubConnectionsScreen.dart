...
class AllClubConnections extends StatefulWidget {
  List<schoolClubConnections> connectionsThroughSchool;
  AllClubConnections(this.connectionsThroughSchool);
  @override
  State<AllClubConnections> createState() =>
      _AllClubConnectionsState();
}

class _AllClubConnectionsState extends State<AllClubConnections> {
  @override
                            ...
                            child: ListView(
                              ...
                              children: [
                                ...widget.connectionsThroughSchool.map((e) {
                                  ...
                                  bottomText = e.classesInCommon.toString() + " clubs in common";
                                  return InkWell(
                                    onTap: () async {},
                                    child: Container(
                                      width: width * 0.93,
