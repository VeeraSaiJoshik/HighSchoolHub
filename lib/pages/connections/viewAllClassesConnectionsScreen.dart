...
class AllSchoolClassesConnections extends StatefulWidget {
  List<schoolClassConnections> connectionsThroughClasses;
  AllSchoolClassesConnections(this.connectionsThroughClasses);
  @override
  State<AllSchoolClassesConnections> createState() =>
      _AllSchoolClassesConnectionsState();
}

class _AllSchoolClassesConnectionsState extends State<AllSchoolClassesConnections> {
  @override
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: ListView(
                              ...
                              children: [
                                ...widget.connectionsThroughClasses.map((e) {
                                  AppUser recommendedUser = e.user;
                                  String bottomText = e.rating.toString() + " classes in common";
                                  return InkWell(
                                    onTap: () async {},
                                    child: Container(
                                      width: width * 0.93,
