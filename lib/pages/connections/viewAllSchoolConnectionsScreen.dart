...
class AllSchoolConnectionScreen extends StatefulWidget {
  List<schoolCalculationNode> connectionsThroughSchool;
  AllSchoolConnectionScreen(this.connectionsThroughSchool);
  @override
  State<AllSchoolConnectionScreen> createState() =>
      _AllSchoolConnectionScreenState();
}

class _AllSchoolConnectionScreenState extends State<AllSchoolConnectionScreen> {
  @override
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: ListView(
                              ...
                              children: [
                                ...widget.connectionsThroughSchool.map((e) {
                                  AppUser recommendedUser = e.user;
                                  String bottomText = "";
                                  if (e.years[e.years.length - 1].school.name ==
                                      e.user.getCurrentSchool().name) {
                                    bottomText = "Studying at ";
                                  } else {
                                    bottomText = "Studied at ";
                                  }
                                  bottomText = bottomText +
                                      e.years[e.years.length - 1].school.name;
                                  return InkWell(
                                    onTap: () async {},
                                    child: Container(
                                      width: width * 0.93,
